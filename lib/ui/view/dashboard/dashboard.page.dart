...
import 'package:quiz_enem/ui/view/dashboard/widgets/card-perguntas_mobile.dart';

import '../../../controllers/auth/sign_in.controller.dart';
import '../../../models/materia.model.dart';
import 'widgets/card-perguntas_web.dart';
                                      ...
                                      onPressed: () async {
                                        if (ctrl.idMateria != null &&
                                          ...
                                          await AlertDialogPopupsComponent.show(
                                              ...
                                              contentText:
                                                  'Clique no menu lateral para selecionar a matéria e o assunto.',
                                              imageUrl:
